...
| CP-301 | P1 | IN_PROGRESS | L | Task Force/Battlegroup embark/disembark, berth/cargo/facility capacity, supply transfers, and location invariants. Authorized Disembark, Task Force resupply, campaign Support, tactical deployment and scenario-priced formation movement now submit and resolve through their coordinators. General embark capacity, multi-store transfers and recovery re-embarkation remain open. | CP-207, CP-300, DEC-008 | Cross-Battalion and over-capacity operations fail; carried forces cannot exist on-map simultaneously. |
...
| CP-603 | P1 | IN_PROGRESS | L | Terminal campaign effects close active deployments, preserve destroyed units, return survivors to `RESERVE` at the operation node with exact health/ammo/supply, unlock loadouts, close carrier links and place Battlegroups in `RECOVERING`. Strategic arrival moves reserve members with a ground Battlegroup and now also moves every active Task Force ship to the destination semantic location/Planet. Deployment rejects persistent ground-location and embarked cross-planet teleportation. Re-embark, resupply and repair UX remain open. | CP-301, CP-601–CP-602 | Survivors return with exact damage/ammo/supply/history and later deploy elsewhere. |
