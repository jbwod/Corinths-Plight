...
| CP-502 | P1 | IN_PROGRESS | L | Support mechanics verticals. Combat Medic First Aid and field resupply and Engineer vehicle Repair are playable end to end. Artillery now starts packed and has playable Deploy/Pack Up transitions at the V5 half-Speed Standard Action cost; deployed state gates movement and fire and survives round persistence. Construction, Bombardment/Funnel, structures, MASH and general tactical supply remain open. | CP-500, DEC-006/DEC-009 | Each activated support action consumes the authoritative actor/resource and persists deterministic progress/effects. |
