...
| CP-404 | P1 | IN_PROGRESS | L | Public Outpost K-17: setup, map, membership, deployment, enemy force, objectives, waves, outcomes, rewards and report. Authenticated campaign discovery/join/deployment, authored K-17 content, four-round capture/outcome logic, terminal behavior, round reports and acknowledgement-gated persistent effects are now present. Enemy waves, rewards, reinforcement/withdrawal and multi-account preview evidence remain open. | CP-400–CP-403 | Two preview accounts complete multiple rounds and a destroyed equipped unit persists exactly once. |
