...
| CP-501 | P1 | IN_PROGRESS | L | Multiweapon, Rapid Fire, arcs/domain, rear exclusions, subsystem damage/repair, indirect spotting, ammo/cooldown and simultaneous reports. The governed subsystem durability profile now drives penetrating natural-5/6 weapon/mobility failures; they are committed after simultaneous attacks, persist to owned units, block later fire/movement, appear in reports/UI, and are repairable by Engineers. Multiweapon, Rapid Fire, firing-domain/rear exclusions and expanded calculation provenance remain open. | CP-200, applicable decisions | Reports show auditable calculation; no air flank, overfire, hidden-target or cooldown defect. |
