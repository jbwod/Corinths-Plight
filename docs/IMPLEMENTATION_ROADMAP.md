...
| CP-501 | P1 | IN_PROGRESS | L | Multiweapon, Rapid Fire, arcs/domain, rear exclusions, subsystem damage/repair, indirect spotting, ammo/cooldown and simultaneous reports. Governed tags now apply Rapid Fire versus Horde through the ordinary attack/report path. The governed subsystem durability profile drives penetrating natural-5/6 weapon/mobility failures; they commit after simultaneous attacks, persist, gate later fire/movement, and are Engineer-repairable. Multiweapon, firing-domain/rear exclusions and expanded calculation provenance remain open. | CP-200, applicable decisions | Reports show auditable calculation; no air flank, overfire, hidden-target or cooldown defect. |
