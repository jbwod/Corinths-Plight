...
| CP-502 | P1 | IN_PROGRESS | L | Support mechanics verticals. Combat Medic First Aid and field resupply are playable end to end. Engineer vehicle Repair is also playable: a deployed Engineer in base contact spends one Small Supply and chooses either one lost Hit or one damaged subsystem; the server validates the choice, resolves it before attacks, emits `UNIT_REPAIRED`, and persists vehicle/subsystem and Engineer Supply state. Construction, artillery, structures, MASH and general tactical supply remain open. | CP-500, DEC-006/DEC-009 | Each activated support action consumes the authoritative actor/resource and persists deterministic progress/effects. |
