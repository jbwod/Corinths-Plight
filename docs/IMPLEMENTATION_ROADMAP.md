...
| CP-502 | P1 | IN_PROGRESS | L | Support mechanics verticals. Combat Medic First Aid is now playable end to end: a deployed Medic selects wounded friendly Infantry in base contact, spends one Medical Supply, resolves the V5 D6/current-FS cap, emits `UNIT_HEALED`, and persists health and supply. Engineer, construction, artillery, structures, Medic reload/MASH and general tactical supply remain open. | CP-500, DEC-006/DEC-009 | Each activated support action consumes the authoritative actor/resource and persists deterministic progress/effects. |
