...
| CP-502 | P1 | IN_PROGRESS | L | Support mechanics verticals. Medic support and Engineer vehicle Repair are playable end to end. Engineers can place a V5 Sandbag Line in their current or an adjacent known hex for one Small Supply; the structure persists in campaign state, renders on the map, appears in reports, and grants Infantry +1 Armor against attacks from outside the hex. Artillery starts packed, has playable Deploy/Pack Up, and performs Primary Bombardment against a known spotted hex. Razor wire, tank traps, trench conversion, bridges, Funnel, MASH and general tactical supply remain open. | CP-500, DEC-006/DEC-009 | Each activated support action consumes the authoritative actor/resource and persists deterministic progress/effects. |
