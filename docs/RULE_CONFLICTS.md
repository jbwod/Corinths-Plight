...
| Attack | Partial executable subset | Seeded one-weapon Attack; Range/LOS; indirect fire only with a friendly live spotter that has LOS; ammo/cooldown; ground-only high-ground +1; FS cap; Rapid Fire versus Horde; Armor/AP/Defense; ground-vehicle rear Armor bypass; dug-in ground-infantry rear Defense loss; air-domain exclusion; Hits; Rush multiplier; simultaneous damage; persistent natural-5/6 subsystem malfunctions. Multiweapon, Evasive, melee, firing arcs, and wider aerospace combat remain deferred. |
