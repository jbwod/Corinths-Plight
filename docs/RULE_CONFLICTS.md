...
| Special/support actions | Partial/deferred | Dig In, Load/Unload, finite-weapon Reload, Combat Medic First Aid and field resupply, Engineer vehicle Repair and Sandbag Line construction, and Artillery Deploy/Pack Up/Bombardment have resolver/UI/persistence paths with known action-ledger/occupancy/cargo gaps. Sandbags cost one Small Supply and grant Infantry +1 Armor against fire from outside their hex. Dig In consumes full movement, grants `+2 Defense`, persists, and ends on actual movement. Scan and Deploy Drone remain release-blocked because their advertised state/visibility effects are incomplete. MASH, remaining construction types, Funnel, general Resupply, Garrison, Assault, Break Out, and other unmigrated actions remain deferred. |
