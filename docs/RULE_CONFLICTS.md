...
| Attack | Partial executable subset | Seeded one-weapon Attack; Range/LOS; indirect fire only with a friendly live spotter that has LOS; ammo/cooldown; ground-only high-ground +1; FS cap; Rapid Fire versus Horde; Armor/AP/Defense; generated/scenario-marked non-stacking personnel Cover Armor; ground-vehicle rear Armor bypass; dug-in ground-infantry rear Defense loss; air-domain exclusion; Hits; Rush multiplier; simultaneous damage; persistent natural-5/6 subsystem malfunctions. Multiweapon, directional cover, Evasive, melee, firing arcs, and wider aerospace combat remain deferred. |
...
| Special/support actions | Partial/deferred | Dig In, Load/Unload, finite-weapon Reload, Combat Medic First Aid and field resupply, Engineer vehicle Repair, and Artillery Deploy/Pack Up/Bombardment have resolver/UI/persistence paths with known action-ledger/occupancy/cargo gaps. Dig In consumes full movement, grants `+2 Defense`, persists, and ends on actual movement. Scan and Deploy Drone remain release-blocked because their advertised state/visibility effects are incomplete. MASH, Construct, Funnel, general Resupply, Garrison, Assault, Break Out, and other unmigrated actions remain deferred. |
