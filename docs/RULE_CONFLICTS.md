...
| Attack | Partial executable subset | Seeded one-weapon Attack; Range/LOS; indirect fire only with a friendly live spotter that has LOS; ammo/cooldown; FS cap; Rapid Fire versus Horde; Armor/AP/Defense; rear calculation; Hits; Rush multiplier; simultaneous damage; persistent natural-5/6 subsystem malfunctions. Rear Armor bypass is not correctly category-scoped; multiweapon, high-ground, Evasive, melee, and aerospace details remain deferred. |
