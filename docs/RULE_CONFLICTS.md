...
| Attack | Partial executable subset | Seeded one-weapon Attack; Range/LOS; indirect fire only with a friendly live spotter that has LOS; ammo/cooldown; FS cap; Rapid Fire versus Horde; Armor/AP/Defense; ground-vehicle rear Armor bypass; dug-in ground-infantry rear Defense loss; air-domain exclusion; Hits; Rush multiplier; simultaneous damage; persistent natural-5/6 subsystem malfunctions. Multiweapon, high-ground, Evasive, melee, and wider aerospace combat remain deferred. |
...
| Special/support actions | Partial/deferred | Load/Unload, finite-weapon Reload, Combat Medic First Aid and field resupply, Engineer vehicle Repair, and Artillery Deploy/Pack Up/Bombardment have resolver/UI/persistence paths with known action-ledger/occupancy/cargo gaps. Scan and Deploy Drone remain release-blocked because their advertised state/visibility effects are incomplete. Dig In, MASH, Construct, Funnel, general Resupply, Garrison, Assault, Break Out, and other unmigrated actions remain deferred. |
