...
| Special/support actions | Partial/deferred | Load/Unload, finite-weapon Reload, Combat Medic First Aid and field resupply, Engineer vehicle Repair, and Artillery Deploy/Pack Up have resolver/UI/persistence paths with known action-ledger/occupancy/cargo gaps. Scan and Deploy Drone remain release-blocked because their advertised state/visibility effects are incomplete. Dig In, MASH, Construct, Bombardment/Funnel, general Resupply, Garrison, Assault, Break Out, and other unmigrated actions remain deferred. |
