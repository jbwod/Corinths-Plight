...
| `battalion_administration_receipts` | Migration `0014` records actor-scoped rank create/update/delete and member-rank assignment results. Rank and membership mutation tokens couple compare-and-set writes to their receipt/event guards. |
