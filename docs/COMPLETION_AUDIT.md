...
| Unit/contract tests | Pass | `npm test`: 59 files, 474 tests, Vitest 4.1.10. |
...
| HAT | yes | yes, partial | partial/playable | Speed-7 Atmo Flight, Hits 1, hostile-ground passage, no-ground-spotting, the exact five-slot cargo table and zero-Speed clear straight-route Infantry/Light Vehicle airdrop execute through generated authority. Landing/takeoff, hazardous-drop results and coordinated Supply drops remain deferred. |
