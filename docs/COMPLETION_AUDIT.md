...
| Multi-planet living war | partial | High | One development strategic fixture and a supported manual-resolution slice exist. Iron Rain victory applies its authored Kestrel control and route-unlock consequences exactly once, then returns surviving units and participating Battlegroups to an explicit recovery state at Kestrel Ridge. Production content, strategic travel, automated deployment, recovery actions and additional worlds remain open. | CP-302–CP-305/CP-600–CP-604. |
