...
- Generated executable action grammar and tactical UI: Attack, finite-weapon Reload, Medic field resupply, Load, Unload, First Aid and Engineer Repair; Scan and Drone are rejected and unadvertised until their visibility state effects exist.
