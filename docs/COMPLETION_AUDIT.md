...
| Multi-planet living war | partial | High | One development strategic fixture and a supported manual-resolution slice exist. Iron Rain connects its Operation briefing to a server-authoritative one-Battlegroup deployment commit, applies authored Kestrel control and route-unlock consequences exactly once, then returns survivors and the Battlegroup to recovery. Corinth scenario routes now support submitted, multi-round Task Force/Battlegroup travel through arrival. Production content, travel supply, reinforcement/recovery actions and additional worlds remain open. | CP-302–CP-305/CP-600–CP-604. |
...
| AUD-SCEN-002 — production has only one authored operation | P0 | partial | High | `onboarding-foundation.sql` creates the public K-17 recruiting campaign and insertion zone. The local Iron Rain fixture now supports a real six-unit deployment, Campaign DO bootstrap and round resolution, but production still has no wider strategic map/ships or second curated content pack; those remain DEC-020/CP-304/CP-400 work. | DEC-020/CP-304/CP-400/CP-404 |
