...
| Unit/contract tests | Pass | `npm test`: 55 files, 412 tests, Vitest 4.1.10. |
...
| Multi-planet living war | partial | High | One development strategic fixture and a supported manual-resolution slice exist. Iron Rain connects its Operation briefing to a server-authoritative one-Battlegroup deployment commit, applies authored Kestrel control/route/operation consequences exactly once, returns survivors to recovery, and unlocks the playable Broken Road follow-on at Junction 7. Corinth scenario routes support submitted multi-round Task Force/Battlegroup travel through arrival. Production content, travel supply, recovery actions, longer operation chains and additional worlds remain open. | CP-302–CP-305/CP-600–CP-604. |
...
| AUD-SCEN-002 — production has only one authored operation | P0 | partial | High | `onboarding-foundation.sql` creates the public K-17 recruiting campaign and insertion zone. The local strategic fixture now chains playable Iron Rain into playable Broken Road with real deployment, campaign initialization and result-driven unlocking, but production still has no wider strategic map/ships or curated operation chain; those remain DEC-020/CP-304/CP-400 work. | DEC-020/CP-304/CP-400/CP-404 |
