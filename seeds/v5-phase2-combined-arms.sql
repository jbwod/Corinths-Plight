...
INSERT INTO unit_class_definitions (
  ...
  ('unit-combat-medic', 'ruleset-v5-core-curated-1', 'Combat Medical Unit', 'SUPPORT', 'FORCE_STRENGTH', 4, 0, 0, 4, 0, 4, 'active', 'V5 / Starting Unit Classes / Medics; Classes.html row 4 for non-conflicting Speed', 'V5 FS4/D6-capped heal/base contact/Medical Supply is selected by RC-UNIT-002 and RC-V5-009; public-v1-economy@1 sets the application price.', '{"raw":{"v5":{"fs":4,"medicalSupply":4},"companion":{"fs":3,"armor":0,"speed":1,"range":1,"fixedHeal":2}},"sensorRange":"SCENARIO_DEFINED","role":"MEDICAL_SUPPORT","nonCombat":true,"conflictIds":["RC-UNIT-002","RC-V5-009","RC-V5-014"]}'),
  ...
  ('unit-logi-truck', 'ruleset-v5-core-curated-1', 'Logi Truck', 'SUPPORT', 'HITS', 1, 0, 0, 12, 0, 6, 'active', 'V5 / Starting Unit Classes / Logi Truck', 'V5 Crew/Hits and cargo-slot conversions selected by RC-UNIT-005; public-v1-economy@1 sets the application price.', '{"crew":3,"sensorRange":"SCENARIO_DEFINED","role":"LOGISTICS","weaponIds":[],"cargoProfileId":"cargo-logi-two-slot","tags":["VEHICLE","TRANSPORT","LOGISTICS"],"conflictIds":["RC-V5-014"]}'),
  ('unit-infantry-fighting-vehicle', 'ruleset-v5-core-curated-1', 'Infantry Fighting Vehicle', 'ARMOUR', 'HITS', 3, 2, 0, 8, 0, 8, 'active', 'V5 / Starting Unit Classes / Infantry Fighting Vehicle', 'V5 IFV remains distinct from companion Mechanized Infantry under RC-UNIT-007; public-v1-economy@1 sets the application price.', '{"crew":3,"sensorRange":"SCENARIO_DEFINED","role":"MECHANISED_TRANSPORT","weaponIds":["weapon-ifv-snub-autocannon"],"tags":["VEHICLE","ARMOURED","SUBSYSTEMS","TRANSPORT"],"conflictIds":["RC-UNIT-007","RC-V5-014"]}'),
  ('unit-light-mech', 'ruleset-v5-core-curated-1', 'Light Mech', 'MECH', 'HITS', 2, 1, 0, 16, 0, 10, 'active', 'V5 / Starting Unit Classes / Light Mech', 'V5 profile selected by RC-UNIT-009; public-v1-economy@1 sets the application price.', '{"crew":1,"sensorRange":"SCENARIO_DEFINED","role":"MOBILE_MECH","weaponIds":["weapon-light-mech-laser"],"tags":["VEHICLE","ARMOURED","MECH","SUBSYSTEMS","EVASIVE_CAPABLE"],"conflictIds":["RC-UNIT-009","RC-V5-014"]}'),
  ('unit-aerospace-fighter', 'ruleset-v5-core-curated-1', 'Aerospace Fighter', 'AEROSPACE', 'HITS', 2, 0, 0, 28, 0, 12, 'active', 'V5 / Starting Unit Classes / Aerospace Fighter', 'V5 profile selected by RC-UNIT-010; public-v1-economy@1 sets the application price.', '{"crew":1,"role":"AEROSPACE_INTERCEPTOR","weaponIds":["weapon-fighter-snub-hmg"],"tags":["VEHICLE","AEROSPACE","ATMO_FLIGHT","AEROSPACE_INTERCEPTOR","RAPID_FIRE","EVASIVE_CAPABLE"],"firingArc":{"degrees":180,"relativeTo":"TRAVEL_PATH","direction":"FORWARD"}}'),
  ('unit-aerospace-bomber', 'ruleset-v5-core-curated-1', 'Aerospace Bomber', 'AEROSPACE', 'HITS', 2, 0, 0, 24, 0, 12, 'active', 'V5 / Starting Unit Classes / Aerospace Bomber', 'V5 profile selected by RC-UNIT-011; public-v1-economy@1 sets the application price.', '{"crew":1,"role":"PATH_BOMBARDMENT","weaponIds":["weapon-bomber-ordnance"],"tags":["VEHICLE","AEROSPACE","ATMO_FLIGHT"],"attackGeometry":"FLY_OVER"}'),
  ('unit-vtol', 'ruleset-v5-core-curated-1', 'VTOL', 'AEROSPACE', 'HITS', 2, 1, 0, 20, 0, 10, 'active', 'V5 / Starting Unit Classes / VTOL', 'Generic V5 VTOL only; public-v1-economy@1 sets the application price.', '{"crew":3,"role":"AIR_MOBILE_SUPPORT","weaponIds":["weapon-vtol-nose-gun"],"tags":["VEHICLE","AEROSPACE","VTOL","ARMOURED","TRANSPORT"]}'),
  ('unit-heavy-air-transport', 'ruleset-v5-core-curated-1', 'Heavy Air Transport', 'AEROSPACE', 'HITS', 1, 0, 0, 28, 0, 14, 'active', 'V5 / Starting Unit Classes / Heavy Air Transport', 'V5 Hits and five-slot conversion table selected by RC-UNIT-013; public-v1-economy@1 sets the application price.', '{"crew":3,"role":"STRATEGIC_AIRLIFT","weaponIds":[],"tags":["VEHICLE","AEROSPACE","ATMO_FLIGHT","TRANSPORT","LOGISTICS"],"cargoProfileId":"cargo-hat-five-slot"}')
...
INSERT INTO action_definitions (
  ...
  ('action-airdrop', 'ruleset-v5-core-curated-1', 'Airdrop', 'INCIDENTAL', 0, 'active', 'V5 / Heavy Air Transport', 'Clear-space in-flight Infantry/Light Vehicle exit is a no-Speed-cost HAT exception; hazardous outcomes remain blocked by RC-V5-018.', '{"requiredAbility":"AIRDROP","targetMustLieOnRoute":true,"clearOpenHexOnly":true,"costPerCargoSlotQuarters":0,"canonicalException":"HAT_CLEAR_IN_FLIGHT_EXIT_NO_SPEED_COST","conflictIds":["RC-V5-010","RC-V5-018"]}'),
...
INSERT INTO ruleset_implementation_overlays (
  ...
  ('UNIT', 'unit-infantry-squad', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["FS","ATTACK","MOVEMENT","FACING","DIG_IN","TRENCH_UPGRADE","GARRISON","FLAK_VESTS","LIGHT_AT","PERSISTENCE","REPORTS","AI_RESPONSE"],"missing":[]}'),
  ...
  ('UNIT', 'unit-combat-medic', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["FIRST_AID","MEDICAL_SUPPLY_RELOAD","DIG_IN","PERSISTENCE","REPORTS"],"excludedByProfile":["MASH"],"missing":[]}'),
  ...
  ('UNIT', 'unit-engineers', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["FS","MOVEMENT","REPAIR_ACTION","ARTILLERY_DIG_IN","FIELDWORKS","RIVER_EDGE_BRIDGE"],"missing":[]}'),
  ('UNIT', 'unit-artillery', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["DEPLOY_PACK_STATE","BOMBARDMENT","FUNNEL","TOWING"],"excludedByProfile":["ANTI_ORBITAL"],"missing":[]}'),
  ('UNIT', 'unit-logi-truck', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["CARGO","TOWING","TYPED_SUPPLY_TRANSFER","COORDINATED_HAT_DROP","CARRIER_LOSS_ADJUDICATION"],"missing":[]}'),
  ('UNIT', 'unit-light-vehicle', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["HITS","ATTACK","MOVEMENT","SUBSYSTEMS","RAPID_FIRE","EVASIVE","PASSENGER_OR_SUPPLY_CARGO","PERSISTENCE","REPORTS","AI_RESPONSE"],"missing":[]}'),
  ('UNIT', 'unit-infantry-fighting-vehicle', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["HITS","ARMOUR","AP","CARGO","SUBSYSTEMS","CREW_REPAIR","PERSISTENCE","REPORTS"],"missing":[]}'),
  ('UNIT', 'unit-main-battle-tank', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["HITS","ARMOUR","AP","FACING","REAR_ATTACK","ARMOUR_TARGET_PRIORITY","SUBSYSTEMS","CREW_REPAIR","PERSISTENCE","REPORTS","AI_RESPONSE"],"missing":[]}'),
  ('UNIT', 'unit-light-mech', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["HITS","ARMOUR","ATTACK","MOVEMENT","HOSTILE_PASSAGE","SUBSYSTEMS","EVASIVE","PERSISTENCE","REPORTS"],"missing":[]}'),
  ('UNIT', 'unit-aerospace-fighter', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["FLIGHT_PATH","FORWARD_ARC","AMMUNITION","LAND_REARM","INTERCEPT","NO_GROUND_SPOTTING","PERSISTENCE","REPORTS"],"missing":[]}'),
  ('UNIT', 'unit-aerospace-bomber', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["FLIGHT_PATH","FLY_OVER_ATTACK","GROUND_ONLY_ORDNANCE","AMMUNITION","LAND_REARM","NO_GROUND_SPOTTING","PERSISTENCE","REPORTS"],"missing":[]}'),
  ('UNIT', 'unit-vtol', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["VTOL_FLIGHT","HOSTILE_PASSAGE","LAND_TAKEOFF","NO_GROUND_SPOTTING","ALTERNATIVE_CARGO","PERSISTENCE","REPORTS"],"missing":[]}'),
  ('UNIT', 'unit-heavy-air-transport', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'PUBLISHED', 'AVAILABLE', 1, 1, NULL, 'phase2-forces.md', 'Persistent force catalogue', '{"economyPolicyId":"public-v1-economy@1","implementedSubset":["FLIGHT_PATH","FIVE_SLOT_CARGO","CLEAR_ROUTE_AIRDROP","COORDINATED_SUPPLY_DROP","LAND_TAKEOFF","CARRIER_LOSS_ADJUDICATION"],"failClosed":["HAZARDOUS_DROP_DESTINATION"],"missing":[]}'),
  ...
  ('STRUCTURE', 'structure-bridge', 'ruleset-v5-core-curated-1', 'IMPLEMENTED', 'NOT_APPLICABLE', 'AVAILABLE', 1, 0, NULL, 'rules/Meta - Core Rules (V5).md', 'Engineers / Bridge', '{"durability":"NON_ATTACKABLE_PUBLIC_V1","applicationProfileId":"public-v1-engineer-bridge@1"}'),
...
-- Owner-approved public-v1 application economy. Companion-only classes remain
-- unavailable; the thirteen canonical V5 non-orbital classes are published.
UPDATE ruleset_implementation_overlays
   SET requisition_status = 'PUBLISHED',
       availability_status = 'AVAILABLE',
       purchasable = 1,
       reason_code = NULL,
       overlay_json = json_patch(overlay_json, '{"economyPolicyId":"public-v1-economy@1"}')
 WHERE definition_kind = 'UNIT'
   AND ruleset_id = 'ruleset-v5-core-curated-1'
   AND definition_id IN (
     'unit-infantry-squad','unit-combat-medic','unit-engineers','unit-artillery',
     'unit-logi-truck','unit-light-vehicle','unit-infantry-fighting-vehicle',
     'unit-main-battle-tank','unit-light-mech','unit-vtol',
     'unit-aerospace-fighter','unit-aerospace-bomber','unit-heavy-air-transport'
   );
