...
INSERT INTO ruleset_implementation_overlays (
  ...
  ('UNIT', 'unit-combat-medic', 'ruleset-v5-core-curated-1', 'PARTIAL', 'BALANCE_REQUIRED', 'DEV_ONLY', 1, 0, 'MISSING_CANONICAL_PRICE', 'phase2-forces.md', 'Persistent force catalogue', '{"implementedSubset":["FIRST_AID","MEDICAL_SUPPLY"],"missing":["MASH"]}'),
