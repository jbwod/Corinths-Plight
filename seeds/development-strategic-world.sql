...
INSERT INTO battalion_permission_definitions (
  ...
  ('BATTLEGROUP_ASSIGN', 'Assign eligible units to a Battlegroup.', 'SCHEMA_ONLY'),
  ('OPERATION_CREATE', 'Create a strategic operation.', 'SCHEMA_ONLY'),
  ('OPERATION_COMMAND', 'Coordinate and command an operation.', 'SCHEMA_ONLY'),
  ...
  ('SUPPLY_MANAGE', 'Transfer or consume Battalion supply.', 'SCHEMA_ONLY'),
