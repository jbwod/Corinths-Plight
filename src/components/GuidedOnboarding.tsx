...
const tourStops = [
  ...
  { key: "REPORTS", title: "Reports", copy: "Read the authoritative round record, campaign outcome, service credit, and published Requisition award." },
] as const;
...
export function GuidedOnboarding({ user, demo, children }: { user: AuthUserDto; demo: boolean; children: ReactNode }) {
  ...
  async function finish() {
    ...
    try {
      ...
      window.location.assign("/?view=forces");
    } catch (caught) {
