...
const abilityCopy: Record<string, Omit<ForceAbilityView, "id">> = {
  ...
  TRANSPORT: { name: "Transport", description: "Embark and disembark compatible units using shared cargo rules.", status: "IMPLEMENTED" },
  CREW_REPAIR: { name: "Crew Repair", description: "Attempt to recover a damaged internal subsystem while exposing the crew.", status: "IMPLEMENTED" },
...
const weapons = {
  ...
  mechLaser: weapon("weapon-light-mech-laser", "Light Laser Cannon", 4, 1, 0, ["MECH"]),
  fighter: weapon("weapon-fighter-snub-hmg", "Snub-HMG", 4, 1, 0, ["AEROSPACE", "FORWARD_ARC", "RAPID_FIRE"], 1),
  bombs: weapon("weapon-bomber-ordnance", "Bomber Ordnance", 6, 0, 0, ["ORDNANCE", "FLY_OVER"], 1),
...
export const SHOWCASE_FORCE: ForceUnitView[] = [
  ...
  showcaseUnit({ id: "force-carrier-6", definitionId: "unit-infantry-fighting-vehicle", callsign: "CARR-6", name: "6th Mechanised Infantry Carrier", className: "Infantry Fighting Vehicle", description: "Armoured infantry carrier with an anti-armour cannon.", role: "ARMOUR", healthModel: "HITS", health: 3, maximumHealth: 3, armour: 2, speed: 2, sensors: 4, movement: "Tracked Ground", battlegroup: "HAMMER", tags: ["VEHICLE", "ARMOURED", "TRANSPORT", "SUBSYSTEMS"], abilityIds: ["TRANSPORT", "CREW_REPAIR"], unitWeapons: [weapons.autocannon], cargo: [{ id: "cargo-raven", label: "Raven-3 Infantry", quantity: 1, kind: "PERSONNEL" }], subsystems: operationalVehicle }),
  showcaseUnit({ id: "force-bellator", definitionId: "unit-main-battle-tank", callsign: "BELLATR", name: "14th Armoured Platoon", className: "Main Battle Tank", description: "Heavy line-breaker with strong frontal armour and high AP.", role: "ARMOUR", healthModel: "HITS", health: 2, maximumHealth: 3, armour: 3, speed: 2, movement: "Tracked Ground", battlegroup: "HAMMER", tags: ["VEHICLE", "ARMOURED", "HEAVY", "SUBSYSTEMS", "FACING", "ARMOUR_TARGET_PRIORITY"], abilityIds: ["CREW_REPAIR"], unitWeapons: [weapons.cannon], subsystems: [{ id: "weapons", name: "Weapons", state: "OPERATIONAL" }, { id: "mobility", name: "Mobility", state: "DAMAGED" }], status: "DAMAGED", readiness: readinessDamaged, equipment: [], serviceCampaigns: 3, serviceRounds: 24 }),
  showcaseUnit({ id: "force-strider", definitionId: "unit-light-mech", callsign: "STRIDER", name: "Strider Light Mech Lance", className: "Light Mech", description: "Mobile weapons platform able to stride through hostile formations.", role: "MECH", healthModel: "HITS", health: 2, maximumHealth: 2, armour: 1, speed: 4, movement: "Mech Ground", tags: ["MECH", "ARMOURED", "SUBSYSTEMS", "EVASIVE"], abilityIds: ["HOSTILE_PASSAGE", "EVASIVE"], unitWeapons: [weapons.mechLaser], subsystems: operationalVehicle }),
  showcaseUnit({ id: "force-vulture", definitionId: "unit-aerospace-fighter", callsign: "VULT-1", name: "1st Vulture Interceptor", className: "Aerospace Fighter", description: "Forward-arc interceptor with one attack of main ammunition and a flight path.", role: "AEROSPACE", healthModel: "HITS", health: 2, maximumHealth: 2, armour: 0, speed: 7, movement: "Aerospace Flight", tags: ["AEROSPACE", "AEROSPACE_INTERCEPTOR", "EVASIVE", "LIMITED_FORWARD_ARC", "CANNOT_SPOT_GROUND"], abilityIds: ["INTERCEPT", "EVASIVE", "REARM_AEROSPACE"], unitWeapons: [weapons.fighter], ammunition: { "weapon-fighter-snub-hmg": 1 }, readiness: readinessNoFlightDeck }),
  showcaseUnit({ id: "force-hammer", definitionId: "unit-aerospace-bomber", callsign: "HAMMR-2", name: "2nd Hammer Bomber", className: "Aerospace Bomber", description: "One-shot ordnance aircraft that attacks a ground target crossed by its Advance route.", role: "AEROSPACE", healthModel: "HITS", health: 2, maximumHealth: 2, armour: 0, speed: 6, movement: "Aerospace Flight", tags: ["AEROSPACE", "BOMBER", "FLY_OVER", "CANNOT_SPOT_GROUND"], abilityIds: ["BOMB_RUN", "REARM_AEROSPACE"], unitWeapons: [weapons.bombs], ammunition: { "weapon-bomber-ordnance": 1 } }),
  showcaseUnit({ id: "force-kestrel", definitionId: "unit-vtol", callsign: "KESTREL", name: "Kestrel VTOL Flight", className: "VTOL", description: "Air-mobile fire support with a mutually-exclusive Infantry or Small Supply hold.", role: "AEROSPACE", healthModel: "HITS", health: 2, maximumHealth: 2, armour: 1, speed: 5, movement: "VTOL Flight", tags: ["VTOL", "AEROSPACE", "TRANSPORT", "CANNOT_SPOT_GROUND"], abilityIds: ["TRANSPORT", "LAND", "TAKE_OFF"], unitWeapons: [weapons.noseGun], cargo: [{ id: "cargo-medic", label: "Medical Team", quantity: 1, kind: "PERSONNEL" }] }),
